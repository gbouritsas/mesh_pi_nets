    ...
    def __init__(self, 
        ...
        for i in range(len(filters_dec)):
            for j in range(1,len(filters_dec[i])):
                out_activation = 'identity' if i==len(filters_dec)-1 and j==len(filters_dec[-1])-1 else self.activation
            ...
            if i<len(filters_dec)-1:
                out_activation = 'identity' if i==len(filters_dec)-2 and len(filters_dec[-1])==1 else self.activation
